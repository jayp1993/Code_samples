...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:todo-db-server02.database.windows.net,1433;Database=todo-sql-db;Uid=azureuser;Pwd=Admin@123456;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
